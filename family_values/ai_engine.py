...
2. 【この違いが顔を出しやすい場面】
   価値観の違いが、暮らしのどんな場面で顔を出しやすいかを 2〜3 文で。
   「衝突の原因」ではなく「先に知っておくと備えやすいポイント」として、
   責めない言い方で。「性格」ではなく「大切にしているものの違い」として。

3. 【ひとつの見方として】
   「相手はこういう世界を生きているのかもしれない」と気づけるような
    ...
    if comparison.divergent:
        for k, names in list(comparison.divergent.items())[:3]:
            ...
            parts.append(
                ...
                f"同じ場面でも「{c.lean}」の度合いが違います。"
                f"先に知っておくと、備えやすいポイントです。"
            )
    else:
        parts.append(
